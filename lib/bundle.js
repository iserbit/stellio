...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_lodash_random__ = __webpack_require__(31);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__game_js__ = __webpack_require__(34);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__tile_js__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__board_js__ = __webpack_require__(33);
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  queue.on('complete', () => {
    board = new __WEBPACK_IMPORTED_MODULE_3__board_js__["a" /* default */](stage, queue);
    board.render();

    game = new __WEBPACK_IMPORTED_MODULE_1__game_js__["a" /* default */](board);
    game.play();
  }, this);
});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_lodash_random__ = __webpack_require__(31);
...
class Board {
  ...
  createTile(pos, type, queue) {
    const tile = new __WEBPACK_IMPORTED_MODULE_0__tile_js__["a" /* default */](pos, type, queue);
  ...
  checkBoard(initialCheck) {
    ...
    let flattenedGrid = __WEBPACK_IMPORTED_MODULE_3_lodash_flatten___default()(this.grid.slice(0));
