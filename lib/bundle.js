...
class Tile {
  ...
  addMatchZoom(removeTiles) {
    createjs.Tween.get(this.object, { loop: false })
      .to({ scaleX: 1.2, scaleY: 1.2}, 400, createjs.Ease.getPowInOut(2))
      .to({ scaleX: 1, scaleY: 1}, 400, createjs.Ease.getPowInOut(2))
...
var baseRandom = __webpack_require__(52),
    ...
    toFinite = __webpack_require__(106);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_lodash_random__ = __webpack_require__(18);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_lodash_merge__ = __webpack_require__(104);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_lodash_flatten__ = __webpack_require__(100);
...
class Board {
  ...
  createTile(pos, type, initial) {
    type = type || this.types[__WEBPACK_IMPORTED_MODULE_1_lodash_random___default()(0, 5)];

    const tile = new __WEBPACK_IMPORTED_MODULE_0__tile_js__["a" /* default */](pos, type, this.queue);
  ...
  replaceTiles(tiles, initial, afterMove) {
    ...
    tiles.forEach(tile => {
      const type = this.types[__WEBPACK_IMPORTED_MODULE_1_lodash_random___default()(0, 5)];
  ...
  findSwapTgt(tile) {
    return event => {
      ...
      if (rowDiff > -20 && rowDiff <  20
       && colDiff > -70 && colDiff < -20) {
        tgt = grid[tile.row][tile.col - 1];
      }

      // RIGHT
      if (rowDiff > -20 && rowDiff < 20
       && colDiff >  20 && colDiff < 70) {
        tgt = grid[tile.row][tile.col + 1];
      }

      // UP
      if (rowDiff > -70 && rowDiff < -20
       && colDiff > -20 && colDiff < 20) {
        tgt = grid[tile.row - 1][tile.col];
      }

      // DOWN
      if (rowDiff >  20 && rowDiff < 70
       && colDiff > -20 && colDiff < 20) {
        tgt = grid[tile.row + 1][tile.col];
      }

      // L TOP // L BOT // R TOP // R BOT
      if (rowDiff < -20 && colDiff < -20
       || rowDiff >  20 && colDiff < -20
       || rowDiff < -20 && colDiff >  20
       || rowDiff >  20 && colDiff > 20) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_lodash_random__ = __webpack_require__(18);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__game_js__ = __webpack_require__(33);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__tile_js__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__board_js__ = __webpack_require__(32);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__score_js__ = __webpack_require__(34);
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  queue.on('complete', () => {
    const score = new __WEBPACK_IMPORTED_MODULE_4__score_js__["a" /* default */](scoreStage);
    const board = new __WEBPACK_IMPORTED_MODULE_3__board_js__["a" /* default */](stage, queue, score);
  }, this);
